...
import 'package:satyashopping/presentation/rating_and_reviews_screen/rating_and_reviews_screen.dart';
...
import 'widgets/reviewwithphotoslist_item_widget.dart';

// ignore_for_file: must_be_immutable
class RatingAndReviewsWithPhotoScreen extends StatelessWidget {
  RatingAndReviewsWithPhotoScreen({Key? key}) : super(key: key);
            ...
            body: SizedBox(
                ...
                child: Stack(alignment: Alignment.bottomCenter, children: [
                      ...
                      child: Align(
                          ...
                          child: Padding(
                              ...
                              child: Column(
                                  ...
                                  children: [
                                    _buildWithphotoRow(context),
                                    SizedBox(height: 28.v),
                                    _buildReviewWithPhotosList(context)
                                  ])))),
                  Align(
                  ...
                  CustomElevatedButton(
                      ...
                      margin: EdgeInsets.only(right: 17.h, bottom: 44.v),
                      leftIcon: Container(
  ...
  /// Section Widget
  Widget _buildWithphotoRow(BuildContext context) {
    return Padding(
  ...
  /// Section Widget
  Widget _buildReviewWithPhotosList(BuildContext context) {
    return Expanded(
        child: ListView.separated(
            ...
            itemBuilder: (context, index) {
              return ReviewwithphotoslistItemWidget();
            }));
  }
