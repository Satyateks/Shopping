...
import 'package:satyashopping/presentation/shipping_addresses_screen/shipping_addresses_screen.dart';
...
class _AddShippingAddressScreenState extends State<AddShippingAddressScreen> {
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context) {
    return CustomAppBar(
        ...
        centerTitle: true,
        title: AppbarTitle(text: "Adding Shipping Address"),
  ...
  /// Section Widget
  Widget _buildStateTextField(BuildContext context) {
    return CustomFloatingTextField(
