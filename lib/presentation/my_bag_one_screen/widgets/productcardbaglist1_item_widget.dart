...
class Productcardbaglist1ItemWidget extends StatelessWidget {
  const Productcardbaglist1ItemWidget({Key? key})
      : super(
          key: key,
        );
                          ...
                          child: Row(
                            ...
                            children: [
                              CustomIconButton(
                                ...
                                decoration:
                                    IconButtonStyleHelper.outlineBlackTL181,
                                child: CustomImageView(
                                  imagePath: ImageConstant.imgIconGray50036x36,
                                ),
                              ),
                              Padding(
                                padding: EdgeInsets.only(
